...
import personTypeRouter from './routes/personType';
import unitPersonRouter from './routes/unitPerson';
import vehicleRouter from './routes/vehicle';
import personVehicleRouter from './routes/personVehicle';
...
app.use(`${BASE_PATH}/estate`, estateRouter);
app.use(`${BASE_PATH}/unit`, unitRouter);
app.use(`${BASE_PATH}/person`, personRouter);
app.use(`${BASE_PATH}/person-type`, personTypeRouter);
app.use(`${BASE_PATH}/unit-person`, unitPersonRouter);
app.use(`${BASE_PATH}/vehicle`, vehicleRouter);
app.use(`${BASE_PATH}/person-vehicle`, personVehicleRouter);
app.use(`${BASE_PATH}/guest`, guestRouter);
app.use(`${BASE_PATH}/setting`, settingRouter);
